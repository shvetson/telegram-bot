...
set CLASSPATH=%APP_HOME%\lib\app-ktor-all.jar

@rem Execute app-ktor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APP_KTOR_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%APP_KTOR_EXIT_CONSOLE%" exit 1
exit /b 1
